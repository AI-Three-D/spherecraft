...
export class StarSystem {
    ...
    _calculateOrbitalMoonPhase(moon) {
        ...
        const cross = new THREE.Vector3().crossVectors(toStar, toMoon);
    ...
    getMoonInfo(localPos = { x: 0, y: 0, z: 0 }, moonOrId = null) {
        ...
        let direction = new THREE.Vector3(dx / distance, dy / distance, dz / distance);
        ...
        const dailyRotation = new THREE.Matrix4().makeRotationAxis(
        ...
        const localUp = new THREE.Vector3(localPos.x, localPos.y, localPos.z).normalize();
    ...
    _getDefaultMoonInfo() {
        return {
            direction: new THREE.Vector3(0, 0.5, 0.5).normalize(),
            distance: 384400000,
