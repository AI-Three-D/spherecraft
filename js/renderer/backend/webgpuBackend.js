...
compileShader(material) {
    ...
    const chunkFmtKey = ['height','normal','tile','splatData','macro','terrainAO','groundField']
        .map(t => chunkFmts[t] || '')
        .join('|');
...
_createTerrainBindGroupLayouts(
    ...
    const slotTypes = ['height', 'normal', 'tile', 'splatData', 'macro'];
