...
fn main(
    ...
    for (var candidateIdx = threadIdx; candidateIdx < td.totalCandidates; candidateIdx += WORKGROUP_SIZE) {
        ...
        let heightSample = textureLoad(heightTex, hCoord, td.layer, 0).r;
