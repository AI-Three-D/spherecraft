...
export class CloudRenderer {
    constructor(backend, config = {}) {
        ...
        this._tmpInvProj = new THREE.Matrix4();
        this._tmpViewMatrix = new THREE.Matrix4();
    }
    ...
    getCommonUniformValues(camera, environmentState, uniformManager) {
        ...
        return {
            ...
            // Aliases for WebGL2 renderer compatibility
            cloudLowCoverage: coverage.cumulus,
            cloudHighCoverage: coverage.cirrus,
