...
export class WebGPUCloudRenderer extends CloudRenderer {
    ...
    update(camera, environmentState, uniformManager) {
        ...
        // --- SMOOTHING LOGIC ---
        const targetWindDir = environmentState?.windDirection || new THREE.Vector2(1, 0);
        ...
        const origin = this.planetConfig.origin || new THREE.Vector3(0, 0, 0);
...
setVolumetricEnabled(enabled) {
    ...
    async initialize() {
        ...
        this.prevViewDir = new THREE.Vector3();
        this.frameCount = 0;
