...
import { getGenericMeshShaders } from '../renderer/shaders/genericMeshShaders.js';
    ...
    async createMaterial(backend) {
        ...
        const material = new Material({
            ...
            uniforms: {
                ...
                baseColor: { value: new THREE.Vector3(this.baseColor.r, this.baseColor.g, this.baseColor.b) },
                metalness: { value: 0.7 },
                roughness: { value: 0.3 },
                emissiveColor: { value: new THREE.Vector3(this.emissiveColor.r, this.emissiveColor.g, this.emissiveColor.b) },
                emissiveIntensity: { value: this.emissiveIntensity },
                
                sunDirection: { value: new THREE.Vector3(0.5, 1.0, 0.3).normalize() },
                sunColor: { value: new THREE.Vector3(1.0, 0.98, 0.95) },
                sunIntensity: { value: 2.0 },
                ambientColor: { value: new THREE.Vector3(0.1, 0.12, 0.15) },
