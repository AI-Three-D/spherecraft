...
import { Vector3, Color } from '../../shared/math/index.js';
...
export class LightingController {
    constructor() {
        ...
        this._cache = {
            ...
            moonIntensity: 0,
            moonColor: new Color(0.8, 0.85, 0.95), // Slightly blue
            moonPhase: 0.5,
     ...
     * @param {Vector3} cameraWorldPosition
