...
export const DEFAULT_ATMO_BANK_CONFIG = Object.freeze({
    [ATMO_BANK_TYPES.VALLEY_MIST]: Object.freeze({
        ...
        color: Object.freeze([0.75, 0.78, 0.82, 0.22]),
        fadeNearStart: 20.0,
        fadeFarStart: 1200.0,
        fadeFarEnd: 2000.0,
    ...
    [ATMO_BANK_TYPES.FOG_POCKET]: Object.freeze({
        ...
        color: Object.freeze([0.72, 0.75, 0.80, 0.25]),
        fadeNearStart: 10.0,
        fadeFarStart: 800.0,
        fadeFarEnd: 1500.0,
        densityThreshold: 0.48,
    ...
    [ATMO_BANK_TYPES.LOW_CLOUD]: Object.freeze({
        ...
        color: Object.freeze([0.82, 0.84, 0.88, 0.34]),
        fadeNearStart: 30.0,
        fadeFarStart: 1500.0,
        fadeFarEnd: 2500.0,
    ...
    [ATMO_BANK_TYPES.PEAK_CLOUD]: Object.freeze({
        ...
        color: Object.freeze([0.88, 0.90, 0.94, 0.30]),
        fadeNearStart: 40.0,
        fadeFarStart: 1800.0,
        fadeFarEnd: 3000.0,
