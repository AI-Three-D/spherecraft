...
export class PostProcessingPipeline {
    ...
    execute(backend) {
        ...
        // produces a bloom texture that gets composited. Added in iteration 2.
        if (this.bloomPass) {
            this.bloomPass.render(encoder, this.hdrTextureView, this.width, this.height);
        }
    ...
    _rebuildBindGroups() {
        ...
        this._tmBindGroup = this.toneMappingPass.createBindGroup(this.hdrTextureView);
    }
